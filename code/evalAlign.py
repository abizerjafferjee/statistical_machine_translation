...
if __name__ == "__main__":
    hansard_english = '/data/Hansard/Testing/Task5.e'
    hansard_french = '/data/Hansard/Testing/Task5.f'
    google_english = '/data/Hansard/Testing/Task5.google.e'
    saved_files = '/test'
    LM_PATH = '{}/LM_e'.format(saved_files)
    train_dir = '//data/Hansard/Training/'
    fn_AM = '{}/AM_test'.format(saved_files)
    report_path = '{}/Task5_test.txt'.format(saved_files)
